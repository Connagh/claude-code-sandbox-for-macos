...
sed "s|SCRIPT_DIR=.*|SCRIPT_DIR=\"$SHARE_DIR\"|" cc-seatbelt > "$BIN_DIR/cc-seatbelt"
chmod +x "$BIN_DIR/cc-seatbelt"

echo "Installed to $BIN_DIR/cc-seatbelt"
echo "Profile at $SHARE_DIR/profile.sb"
echo ""
echo "Make sure $BIN_DIR is in your PATH, then run:"
echo "  cc-seatbelt claude"
